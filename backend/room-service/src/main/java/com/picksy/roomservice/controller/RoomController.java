...
public class RoomController {
  ...
  @Operation(
      ...
      description =
          "Creates a new room for voting using the provided request body. The authenticated user becomes the room owner.")
  ...
  @Operation(
      ...
      description =
          "Starts the voting process in a room. Only the room owner is allowed to perform this action.")
  @PatchMapping("/secure/start")
  public ResponseEntity<String> startVoting(
      @RequestHeader("X-User-Id") Long userId, @RequestBody RoomActionRequest request)
  ...
  @Operation(
      ...
      description =
          "Moves the voting process to the next category in the room. Only the room owner is allowed to perform this action.")
  ...
  @Operation(
      ...
      description =
          "Finishes the voting process in the room without closing it. Only the room owner is allowed to perform this action.")
  ...
  @Operation(
      ...
      description =
          "Closes the room and prevents any further actions. Only the room owner is allowed to perform this action.")
  ...
  @Operation(
      ...
      description =
          "Returns detailed information about the room, including current category, participants and voting status.")
  ...
  @Operation(
      ...
      description =
          "Returns a list of closed rooms created or participated in by the authenticated user.")
  @GetMapping("/secure/history")
  public ResponseEntity<List<RoomDTO>> getUserHistory(@RequestHeader("X-User-Id") Long userId)
      throws BadRequestException {
    ...
    @Operation(
            summary = "Join room",
            description = "Adds a participant to the room identified by the given room code and returns the generated participant ID."
    )
    @PatchMapping("/public/{roomCode}/join")
    public ResponseEntity<Long> joinRoom(
        ...
        return ResponseEntity.ok(roomService.joinRoom(roomCode, roomUserInfo));
    }


    @Operation(
            summary = "Leave room",
            description = "Removes a participant from the room identified by the given room code."
    )
    @PatchMapping("/public/{roomCode}/leave")
    public ResponseEntity<String> leaveRoom(
        ...
        roomService.leaveRoom(roomCode, roomUserInfo);
        return ResponseEntity.ok("Room has been successfully left.");
    }


    @Operation(
            summary = "Check participant membership",
            description = "Checks whether a user with the given ID is a participant in the specified room."
    )
    @GetMapping("/secure/participant/{roomCode}")
    public ResponseEntity<Boolean> isParticipant(
      ...
      return ResponseEntity.ok(roomService.isParticipant(roomCode, userId));
    }
}
